        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              //   final (status, _) = await _rtmClient.login(AppConstant.token);
              //   log('[LoginResult] errorCode: ${status.errorCode}');
              // }),
              // _button('RtmClient.logout', () async {
              //   final (status, _) = await _rtmClient.logout();
              //   log('[LogoutResult] errorCode: ${status.errorCode}');
              // }),
              // const Text('RtmChannelType: '),
              // DropdownButton<RtmChannelType>(
              //   items:
              //       RtmChannelType.values
              //           .map(
              //             (e) => DropdownMenuItem(
              //               value: e,
              ...
              //     final (status, result) = await _rtmClient.unsubscribe(
              //       _channelNameController.text,
              //     );
              ...
              //   ),
              //   _textField(
              //     _setChannelMetadataMajorRevisionController,
              //     'Input majorRevision',
              //   ),
              //   _textField(
              ...
              //               revision:
              //                   int.tryParse(
              //                     _setChannelMetadataRevisionController.text,
              //                   ) ??
              //                   0,
              //             ),
              //           )
              ...
              //   _textField(
              //     _rtmClientPublishCustomTypeController,
              //     'Input customType',
              //   ),
              ...
              //     log('[PublishResult] errorCode: ${status.errorCode}');
              //   }),
              ...
              //       RtcEngineContext(appId: AppConstant.appId),
              //     );

              //     log('RtcEngine.initialize success');
              //   }),
              ...
              //     log('RtcEngine.joinChannel success');
              //   }),
              //   _button('Release', () async {
              //     await _rtcEngine.release();

              //     log('RtcEngine.release success');
              //   }),
              // ]),
            ],
          ),
...
class KeyValueInputGroupWidgetController {
  ...
  List<KeyValueInputGroupWidgetPair> get keyValuePairs => UnmodifiableListView(
    _holders.map(
      (e) => KeyValueInputGroupWidgetPair(
        e.keyController.text,
    ...
    return Column(
      ...
      children: [
        ...
        ElevatedButton(
          onPressed: () {
            setState(() {
              widget.controller._holders.add(
                _Holder(
